...
const STYLE_VOICINGS: Record<CompositionStyle, StyleVoicing> = {
  classical: {
    melody: 'piano', harmony: 'strings', bass: 'bass', arpeggio: 'bells', countermelody: 'flute',
    ...
    melodyVol: 0.8, harmonyVol: 0.55, bassVol: 0.7, arpeggioVol: 0.35, drumsVol: 0.5, countermelodyVol: 0.35,
  },
  romantic: {
    melody: 'piano', harmony: 'strings', bass: 'bass', arpeggio: 'bells', countermelody: 'celesta',
    ...
    drumsFx: [{ type: 'compressor', wet: 1, params: { threshold: -15, ratio: 3 } }],
    countermelodyFx: [{ type: 'reverb', wet: 0.4, params: { decay: 4 } }, { type: 'chorus', wet: 0.1, params: { frequency: 0.8, depth: 0.3 } }],
    melodyVol: 0.82, harmonyVol: 0.6, bassVol: 0.65, arpeggioVol: 0.3, drumsVol: 0.4, countermelodyVol: 0.3,
  },
  impressionist: {
    melody: 'piano', harmony: 'pads', bass: 'bass', arpeggio: 'vibraphone', countermelody: 'flute',
    ...
    countermelodyFx: [{ type: 'reverb', wet: 0.5, params: { decay: 5 } }, { type: 'chorus', wet: 0.15, params: { frequency: 0.5, depth: 0.4 } }],
  ...
  jazz: {
    ...
    countermelodyFx: [{ type: 'reverb', wet: 0.2, params: { decay: 2 } }, { type: 'delay', wet: 0.15, params: { delayTime: 0.375, feedback: 0.2 } }],
    melodyVol: 0.78, harmonyVol: 0.5, bassVol: 0.72, arpeggioVol: 0.3, drumsVol: 0.52, countermelodyVol: 0.32,
  },
  neo_soul: {
    melody: 'electric_piano', harmony: 'electric_piano', bass: 'bass', arpeggio: 'vibraphone', countermelody: 'warm_pad',
    ...
    countermelodyFx: [{ type: 'reverb', wet: 0.35, params: { decay: 3.5 } }, { type: 'chorus', wet: 0.15, params: { frequency: 0.6, depth: 0.5 } }],
    melodyVol: 0.76, harmonyVol: 0.52, bassVol: 0.7, arpeggioVol: 0.32, drumsVol: 0.5, countermelodyVol: 0.28,
  },
  ambient: {
    melody: 'pads', harmony: 'pads', bass: 'bass', arpeggio: 'bells', countermelody: 'warm_pad',
    ...
    countermelodyFx: [{ type: 'reverb', wet: 0.65, params: { decay: 9 } }, { type: 'delay', wet: 0.4, params: { delayTime: 0.8, feedback: 0.45 } }],
    melodyVol: 0.65, harmonyVol: 0.55, bassVol: 0.5, arpeggioVol: 0.4, drumsVol: 0.3, countermelodyVol: 0.25,
  },
  minimalist: {
    melody: 'piano', harmony: 'piano', bass: 'bass', arpeggio: 'bells', countermelody: 'vibraphone',
  ...
  cinematic: {
    melody: 'strings', harmony: 'strings', bass: 'bass', arpeggio: 'piano', countermelody: 'choir',
    ...
    countermelodyFx: [{ type: 'reverb', wet: 0.5, params: { decay: 6 } }, { type: 'chorus', wet: 0.2, params: { frequency: 0.4, depth: 0.5 } }],
    melodyVol: 0.82, harmonyVol: 0.65, bassVol: 0.7, arpeggioVol: 0.35, drumsVol: 0.55, countermelodyVol: 0.3,
  },
  electronic: {
    melody: 'synth_lead', harmony: 'pads', bass: 'bass', arpeggio: 'bells', countermelody: 'warm_pad',
    ...
    countermelodyFx: [{ type: 'reverb', wet: 0.3, params: { decay: 3 } }, { type: 'delay', wet: 0.3, params: { delayTime: 0.25, feedback: 0.35 } }],
    melodyVol: 0.8, harmonyVol: 0.5, bassVol: 0.75, arpeggioVol: 0.4, drumsVol: 0.6, countermelodyVol: 0.25,
  },
  bossa_nova: {
    melody: 'nylon_guitar', harmony: 'electric_piano', bass: 'upright_bass', arpeggio: 'vibraphone', countermelody: 'flute',
    ...
    countermelodyFx: [{ type: 'reverb', wet: 0.25, params: { decay: 2.5 } }, { type: 'chorus', wet: 0.08, params: { frequency: 0.5, depth: 0.3 } }],
    melodyVol: 0.78, harmonyVol: 0.48, bassVol: 0.7, arpeggioVol: 0.28, drumsVol: 0.42, countermelodyVol: 0.3,
  },
  lo_fi: {
    melody: 'tape_keys', harmony: 'electric_piano', bass: 'bass', arpeggio: 'vibraphone', countermelody: 'warm_pad',
    ...
    countermelodyFx: [{ type: 'filter', wet: 1, params: { frequency: 2000 } }, { type: 'reverb', wet: 0.4, params: { decay: 4 } }],
    melodyVol: 0.72, harmonyVol: 0.48, bassVol: 0.68, arpeggioVol: 0.32, drumsVol: 0.45, countermelodyVol: 0.25,
  },
  gospel: {
    melody: 'piano', harmony: 'organ', bass: 'bass', arpeggio: 'piano', countermelody: 'choir',
    ...
    countermelodyFx: [{ type: 'reverb', wet: 0.35, params: { decay: 3.5 } }],
    melodyVol: 0.82, harmonyVol: 0.6, bassVol: 0.72, arpeggioVol: 0.3, drumsVol: 0.55, countermelodyVol: 0.28,
  },
};
...
export function compose(params: CompositionParams): Composition {
  ...
  const melodyNotes = humanizeTrack(rawMelody, params.style, 'Melody', beatsPerBar);
  ...
  const countermelodyNotes = params.expressiveness >= 4
    ? humanizeTrack(generateCountermelody(params, chords, rawMelody), params.style, 'Countermelody', beatsPerBar)
    : [];

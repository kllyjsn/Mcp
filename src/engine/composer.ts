...
const STYLE_VOICINGS: Record<CompositionStyle, StyleVoicing> = {
  classical: {
    melody: 'piano', harmony: 'strings', bass: 'bass', arpeggio: 'bells', counterMelody: 'celeste',
    ...
    melodyVol: 0.8, harmonyVol: 0.55, bassVol: 0.7, arpeggioVol: 0.35, drumsVol: 0.5, counterMelodyVol: 0.32,
  },
  romantic: {
    ...
    drumsFx: [{ type: 'compressor', wet: 1, params: { threshold: -15, ratio: 3 } }],
    counterMelodyFx: [{ type: 'reverb', wet: 0.45, params: { decay: 4 } }, { type: 'chorus', wet: 0.1, params: { frequency: 0.8, depth: 0.3 } }],
    melodyVol: 0.82, harmonyVol: 0.6, bassVol: 0.65, arpeggioVol: 0.3, drumsVol: 0.4, counterMelodyVol: 0.35,
  },
  impressionist: {
    melody: 'piano', harmony: 'warm_pad', bass: 'bass', arpeggio: 'vibraphone', counterMelody: 'celeste',
    melodyFx: [{ type: 'reverb', wet: 0.45, params: { decay: 4 } }, { type: 'chorus', wet: 0.15, params: { frequency: 0.8, depth: 0.4 } }],
    harmonyFx: [{ type: 'reverb', wet: 0.55, params: { decay: 6 } }, { type: 'widen', wet: 0.15, params: { depth: 0.2 } }],
    ...
    counterMelodyFx: [{ type: 'reverb', wet: 0.5, params: { decay: 5 } }, { type: 'delay', wet: 0.15, params: { delayTime: 0.5, feedback: 0.25 } }],
    melodyVol: 0.75, harmonyVol: 0.5, bassVol: 0.6, arpeggioVol: 0.4, drumsVol: 0.35, counterMelodyVol: 0.3,
  },
  jazz: {
    melody: 'rhodes', harmony: 'rhodes', bass: 'upright_bass', arpeggio: 'vibraphone', counterMelody: 'muted_trumpet',
    ...
    counterMelodyFx: [{ type: 'reverb', wet: 0.2, params: { decay: 2 } }, { type: 'saturator', wet: 0.05, params: { order: 2 } }],
    melodyVol: 0.78, harmonyVol: 0.5, bassVol: 0.72, arpeggioVol: 0.3, drumsVol: 0.52, counterMelodyVol: 0.34,
  },
  neo_soul: {
    melody: 'rhodes', harmony: 'rhodes', bass: 'analog_bass', arpeggio: 'vibraphone', counterMelody: 'warm_pad',
    ...
    bassFx: [{ type: 'compressor', wet: 1, params: { threshold: -18, ratio: 4 } }, { type: 'filter', wet: 1, params: { frequency: 800 } }, { type: 'saturator', wet: 0.08, params: { order: 2 } }],
    ...
    counterMelodyFx: [{ type: 'reverb', wet: 0.35, params: { decay: 3 } }, { type: 'chorus', wet: 0.12, params: { frequency: 0.5, depth: 0.4 } }],
    melodyVol: 0.76, harmonyVol: 0.52, bassVol: 0.7, arpeggioVol: 0.32, drumsVol: 0.5, counterMelodyVol: 0.3,
  },
  ambient: {
    melody: 'warm_pad', harmony: 'warm_pad', bass: 'analog_bass', arpeggio: 'celeste', counterMelody: 'pads',
    melodyFx: [{ type: 'reverb', wet: 0.6, params: { decay: 8 } }, { type: 'delay', wet: 0.4, params: { delayTime: 0.6, feedback: 0.5 } }],
    harmonyFx: [{ type: 'reverb', wet: 0.7, params: { decay: 10 } }, { type: 'chorus', wet: 0.3, params: { frequency: 0.3, depth: 0.8 } }, { type: 'widen', wet: 0.2, params: { depth: 0.25 } }],
    ...
    counterMelodyFx: [{ type: 'reverb', wet: 0.65, params: { decay: 9 } }, { type: 'delay', wet: 0.3, params: { delayTime: 0.75, feedback: 0.4 } }],
    melodyVol: 0.65, harmonyVol: 0.55, bassVol: 0.5, arpeggioVol: 0.4, drumsVol: 0.3, counterMelodyVol: 0.28,
  },
  minimalist: {
    melody: 'piano', harmony: 'piano', bass: 'bass', arpeggio: 'bells', counterMelody: 'celeste',
    ...
    melodyVol: 0.75, harmonyVol: 0.5, bassVol: 0.6, arpeggioVol: 0.35, drumsVol: 0.35, counterMelodyVol: 0.25,
  },
  cinematic: {
    melody: 'strings', harmony: 'strings', bass: 'analog_bass', arpeggio: 'piano', counterMelody: 'soft_brass',
    melodyFx: [{ type: 'reverb', wet: 0.45, params: { decay: 5 } }],
    harmonyFx: [{ type: 'reverb', wet: 0.55, params: { decay: 6 } }, { type: 'chorus', wet: 0.2, params: { frequency: 0.5, depth: 0.6 } }, { type: 'widen', wet: 0.12, params: { depth: 0.18 } }],
    ...
    counterMelodyFx: [{ type: 'reverb', wet: 0.45, params: { decay: 5 } }, { type: 'widen', wet: 0.1, params: { depth: 0.15 } }],
    melodyVol: 0.82, harmonyVol: 0.65, bassVol: 0.7, arpeggioVol: 0.35, drumsVol: 0.55, counterMelodyVol: 0.38,
  },
  electronic: {
    melody: 'synth_lead', harmony: 'warm_pad', bass: 'analog_bass', arpeggio: 'pluck', counterMelody: 'pads',
    melodyFx: [{ type: 'delay', wet: 0.25, params: { delayTime: 0.25, feedback: 0.3 } }, { type: 'reverb', wet: 0.2, params: { decay: 2 } }],
    harmonyFx: [{ type: 'chorus', wet: 0.3, params: { frequency: 2, depth: 0.7 } }, { type: 'reverb', wet: 0.35, params: { decay: 4 } }, { type: 'widen', wet: 0.15, params: { depth: 0.2 } }],
    bassFx: [{ type: 'compressor', wet: 1, params: { threshold: -15, ratio: 5 } }, { type: 'distortion', wet: 0.1, params: { amount: 0.2 } }, { type: 'saturator', wet: 0.06, params: { order: 2 } }],
    ...
    counterMelodyFx: [{ type: 'reverb', wet: 0.35, params: { decay: 4 } }, { type: 'delay', wet: 0.2, params: { delayTime: 0.375, feedback: 0.3 } }],
    melodyVol: 0.8, harmonyVol: 0.5, bassVol: 0.75, arpeggioVol: 0.4, drumsVol: 0.6, counterMelodyVol: 0.3,
  },
  bossa_nova: {
    melody: 'nylon_guitar', harmony: 'rhodes', bass: 'upright_bass', arpeggio: 'vibraphone', counterMelody: 'celeste',
    ...
    melodyVol: 0.78, harmonyVol: 0.48, bassVol: 0.7, arpeggioVol: 0.28, drumsVol: 0.42, counterMelodyVol: 0.25,
  },
  lo_fi: {
    melody: 'tape_keys', harmony: 'rhodes', bass: 'analog_bass', arpeggio: 'vibraphone', counterMelody: 'warm_pad',
    ...
    harmonyFx: [{ type: 'filter', wet: 1, params: { frequency: 2500 } }, { type: 'reverb', wet: 0.35, params: { decay: 3.5 } }, { type: 'saturator', wet: 0.06, params: { order: 2 } }],
    ...
    counterMelodyFx: [{ type: 'filter', wet: 1, params: { frequency: 2000 } }, { type: 'reverb', wet: 0.35, params: { decay: 3 } }],
    melodyVol: 0.72, harmonyVol: 0.48, bassVol: 0.68, arpeggioVol: 0.32, drumsVol: 0.45, counterMelodyVol: 0.28,
  },
  gospel: {
    melody: 'piano', harmony: 'organ', bass: 'bass', arpeggio: 'piano', counterMelody: 'soft_brass',
    ...
    melodyVol: 0.82, harmonyVol: 0.6, bassVol: 0.72, arpeggioVol: 0.3, drumsVol: 0.55, counterMelodyVol: 0.32,
  },
};
...
export function compose(params: CompositionParams): Composition {
  ...
  const rawMelody = generateMelody(params, chords, [4, 6], tension, phrases);
  const melodyNotes = humanizeTrack(rawMelody, params.style, 'Melody', beatsPerBar, tension);
  const bassNotes = humanizeTrack(generateBassLine(params, chords, tension), params.style, 'Bass', beatsPerBar, tension);
  const padNotes = humanizeTrack(generatePadVoicings(params, chords, tension), params.style, 'Harmony', beatsPerBar, tension);
  const arpeggioNotes = humanizeTrack(generateArpeggio(params, chords, tension), params.style, 'Arpeggio', beatsPerBar, tension);
  const drumNotes = humanizeTrack(generateDrumPattern(params, tension), params.style, 'Drums', beatsPerBar, tension);
  const counterMelodyNotes = humanizeTrack(
    generateCounterMelody(params, chords, rawMelody, tension),
    params.style, 'Counter Melody', beatsPerBar, tension,
  );
...
export function recomposeTrack(
  ...
  const tension = generateTensionCurve(totalBeats, beatsPerBar, params.style, chordProgression);
  const phrases = getPhraseStructures(totalBeats, beatsPerBar, params.style, tension);

  let newNotes;
  switch (track.name) {
    case 'Melody': newNotes = generateMelody(params, chordProgression, [4, 6], tension, phrases); break;
    ...
    case 'Drums': newNotes = generateDrumPattern(params, tension); break;
    default: newNotes = generateMelody(params, chordProgression, [4, 6], tension, phrases);
  }

  newNotes = humanizeTrack(newNotes, params.style, track.name, beatsPerBar, tension);

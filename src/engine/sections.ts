...
const STYLE_ARCS: Record<CompositionStyle, SectionTemplate[]> = {
  ...
  late_night: [
    { kind: 'intro',     weight: 2, tension: 0.15, trackPresence: tp(0, 0.3, 0.4, 0, 0, 0.2) },
    { kind: 'verse',     weight: 3, tension: 0.35, trackPresence: tp(1, 0.5, 0.7, 0.3, 0, 0.4) },
    { kind: 'build',     weight: 1, tension: 0.5,  trackPresence: tp(1, 0.7, 0.8, 0.5, 0.5, 0.5) },
    { kind: 'climax',    weight: 1, tension: 0.6,  trackPresence: tp(1, 0.8, 0.9, 0.6, 0.8, 0.5) },
    { kind: 'outro',     weight: 2, tension: 0.2,  trackPresence: tp(0.5, 0.3, 0.5, 0.2, 0, 0.2) },
  ],
  afrobeat: [
    { kind: 'intro',     weight: 1, tension: 0.3,  trackPresence: tp(0, 0, 0.8, 0, 0, 0.9) },
    { kind: 'verse',     weight: 2, tension: 0.5,  trackPresence: tp(0.8, 0.6, 1, 0.5, 0, 1) },
    { kind: 'build',     weight: 2, tension: 0.7,  trackPresence: tp(1, 0.8, 1, 0.8, 0.5, 1) },
    { kind: 'climax',    weight: 2, tension: 0.95, trackPresence: tp(1, 1, 1, 1, 1, 1) },
    { kind: 'breakdown', weight: 1, tension: 0.4,  trackPresence: tp(0.5, 0.3, 0.8, 0.3, 0, 0.7) },
    { kind: 'outro',     weight: 1, tension: 0.5,  trackPresence: tp(0.6, 0.5, 0.9, 0.4, 0, 0.8) },
  ],
  contemporary_rnb: [
    { kind: 'intro',     weight: 1, tension: 0.15, trackPresence: tp(0, 0.4, 0, 0.3, 0, 0.3) },
    { kind: 'verse',     weight: 2, tension: 0.35, trackPresence: tp(1, 0.6, 0.7, 0.4, 0, 0.6) },
    { kind: 'build',     weight: 1, tension: 0.6,  trackPresence: tp(1, 0.8, 0.9, 0.6, 0.3, 0.7) },
    { kind: 'climax',    weight: 2, tension: 0.85, trackPresence: tp(1, 1, 1, 0.8, 0.8, 0.8) },
    { kind: 'breakdown', weight: 1, tension: 0.25, trackPresence: tp(0.6, 0.5, 0, 0.4, 0, 0.3) },
    { kind: 'outro',     weight: 1, tension: 0.3,  trackPresence: tp(0.7, 0.5, 0.5, 0.3, 0, 0.4) },
  ],
};
